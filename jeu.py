...
def menu():
    ...
    monstre_img = pygame.image.load('menu_monstre.jpg').convert_alpha()
    ...
    while continuer:
        ...
        fenetre.blit(titre_menu, ((LARGEUR//2) - 400, 50))
        fenetre.blit(texte_jouer, (bouton_jouer.x + 200, bouton_jouer.y + 60))
        fenetre.blit(texte_aide, (bouton_aide.x + 200, bouton_aide.y + 60))
        fenetre.blit(texte_quitter, (bouton_quitter.x + 175, bouton_quitter.y + 60))
...
def police(taille): 
    return pygame.font.Font("retro.ttf", taille)
...
def aide():
    while True:
        ...
        fenetre.blit(texte_retour, (bouton_retour.x + 175, bouton_retour.y + 60))
        for evenement in pygame.event.get():
            if evenement.type == pygame.QUIT:
                 sys.exit()
                 pygame.quit()
        ...
        OPTIONS_TEXTE = police(45).render("Déplacements : ", True, "white")
        OPTIONS_RECT = OPTIONS_TEXTE.get_rect(center=(LARGEUR//2, 30))
        fenetre.blit(OPTIONS_TEXTE, OPTIONS_RECT)
        
        OPTIONS_TEXTE_1 = police(45).render("Avancer : z", True, "white")
        OPTIONS_RECT_1 = OPTIONS_TEXTE_1.get_rect(center=(LARGEUR//2, 100))
        fenetre.blit(OPTIONS_TEXTE_1, OPTIONS_RECT_1)
        
        OPTIONS_TEXTE_2 = police(45).render("Reculer : s", True, "white")
        OPTIONS_RECT_2 = OPTIONS_TEXTE_2.get_rect(center=(LARGEUR//2, 170))
        fenetre.blit(OPTIONS_TEXTE_2, OPTIONS_RECT_2)
        
        OPTIONS_TEXTE_3 = police(45).render("Gauche : q", True, "white")
        OPTIONS_RECT_3 = OPTIONS_TEXTE_3.get_rect(center=(LARGEUR//2, 240))
        fenetre.blit(OPTIONS_TEXTE_3, OPTIONS_RECT_3)
        
        OPTIONS_TEXTE_4 = police(45).render("Tirer : clic gauche ", True, "white")
        OPTIONS_RECT_4 = OPTIONS_TEXTE_4.get_rect(center=(LARGEUR//2, 390))
        fenetre.blit(OPTIONS_TEXTE_4, OPTIONS_RECT_4)
        
        OPTIONS_TEXTE_5 = police(45).render("Droite : d ", True, "white")
        OPTIONS_RECT_5 = OPTIONS_TEXTE_5.get_rect(center=(LARGEUR//2, 320))
        fenetre.blit(OPTIONS_TEXTE_5, OPTIONS_RECT_5)
...
def jeux():
    ...
    while True:
        ...
        if len(lst_monstres) == 0 and entree_boss == 6:
            lst_monstres.add(Monstre('Sprites_NSI/boss_2_0.png', 'Sprites_NSI/boss_2_1.png', 'Sprites_NSI/boss_2_2.png', 'Sprites_NSI/boss_2_3.png', 250, 2, 11, 70))
        if len(lst_monstres) == 0 and entree_boss == 10:
            for _ in range(3):
                lst_monstres.add(Monstre('Sprites_NSI/boss_1_0.png', 'Sprites_NSI/boss_1_1.png', 'Sprites_NSI/boss_1_2.png', 'Sprites_NSI/boss_1_3.png', 150, 1.5, 6, -10))
            lst_monstres.add(Monstre('Sprites_NSI/boss_2_0.png', 'Sprites_NSI/boss_2_1.png', 'Sprites_NSI/boss_2_2.png', 'Sprites_NSI/boss_2_3.png', 250, 2, 11, 70))
        # La vague finale, normalement impossible à passer
        if len(lst_monstres) == 0 and entree_boss == 15:
            for _ in range(5):
                lst_monstres.add(Monstre('Sprites_NSI/boss_1_0.png', 'Sprites_NSI/boss_1_1.png', 'Sprites_NSI/boss_1_2.png', 'Sprites_NSI/boss_1_3.png', 150, 1.5, 6, -10))
                lst_monstres.add(Monstre('Sprites_NSI/boss_2_0.png', 'Sprites_NSI/boss_2_1.png', 'Sprites_NSI/boss_2_2.png', 'Sprites_NSI/boss_2_3.png', 250, 2, 11, 70))
        ...
        # Notre personnage et ses méthodes
        player.barre_vie()
        player.draw()
        player.update(0.25)
        score(nb_mort)
